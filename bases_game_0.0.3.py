...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    maxinum = 65535               # ONLY IF YOU ARE AN EINSTEIN
    break
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
  else:
...
''')
  if choice == "binary":
    ...
    TheGameMode = random.randint(0,2)
    if TheGameMode == 0:
      print("the game mode is binary")
      binary()
      break
    elif TheGameMode == 1:
      print("the game mode is hexidecimal")
      hexidecimal()
      break
    else:
      print("the game mode is octal")
      octal()
      break
  else:
    print("not an option ")
